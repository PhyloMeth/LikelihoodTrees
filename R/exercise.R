...
#setwd("/Users/tyson/desktop/PhyloMeth/LikelihoodTrees/inst/extdata")
#library(ips)
#PICK_A_MODEL_FOR_BINARY_TRAITS_WITH_GAMMA_AND_ASCERTAINMENT_BIAS


InferMorphologyTree_exercise <- function(in.place=FALSE, input.path=NULL, input.file = "binary.phy", output.path=NULL, output.name = "morpho1", random.seed=3, model="ASC_BINGAMMA", other='--asc-corr=lewis') {
	if(!in.place) {
...
#PICK_A_MODEL_FOR_GTR+GAMMA
#THE_CALL_TO_RAxML_WITH_TELLING_IT_TO_DO_FAST_BOOTSTRAPPING_AND_SAVING_THE_OPTIMAL_TREE,_SAVE_BOOTSTRAP_TREES_WITH_BRANCH_LENGTHS
